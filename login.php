...
if (isset($_SESSION['id']) && !empty($_SESSION['id'])) header('Location: admin/profile.php');
...
<head>
	...
	<title>Fresh Organic - Login</title>
			...
			<div class="row justify-content-center">
				<div class="col-lg-6">
					<div class="section-title text-center mb-4">
						<h2 class="text-md mb-2" Style="color: #08350C">Login</h2>
						<div class="divider mx-auto my-4"></div>
						<p Style="color: #08350C">Enter your credentials to login.</p>
					</div>
				</div>
			</div>
				...
				<div class="col-lg-8 col-md-8 col-sm-8">
					<form id="login-form" class="contact__form" method="post" action="">
						...
						<div class="text-center">
							<input class="btn btn-main btn-round-full" name="submit" type="submit" Style="background-color: #08350C; border-color: #08350C" value="Login"></input>
						</div>
					</form>

					<div class="row">
						<div class="col-12 text-center mt-4">
							<p Style="color: #08350C">New to Fresh Organic? <a href="register.php">Create Account</a></p>
						</div>
					</div>
				</div>
			</div>
