...
<head>
	...
	<title>Fresh Organic - Update Password</title>
								...
								<div class="blog-item-content">
									...
									<form action="" method="post">
										...
										<div class="row">
											...
											<div class="col-9">
												<div>
													<input class="btn btn-main btn-round-full mt-2" name="submit" type="submit" Style="background-color: #08350C; border-color: #08350C" value="Change Passowrd"></input>
												</div>
											</div>
										</div>
									</form>
